...
എന്റെ പേര് {}! ഞൻ ഒരു അടിപൊളി Group Managing Bot ആണ്.

എന്നെ `python telegram bot` ലൈബ്രറിയിൽ ആണ് നിർമ്മിച്ചത്..
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="➕ Add Me To A Group ➕", url="t.me/{}?startgroup=true".format(bot.username))],
                     [InlineKeyboardButton(text="Updates Channel", url="https://t.me/telebotinstitute"), InlineKeyboardButton(text="Support Group", url="https://t.me/pesexchnangesales")],
                     [InlineKeyboardButton(text="🧑‍💻 Developer", url="https://t.me/tom_killadi"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
